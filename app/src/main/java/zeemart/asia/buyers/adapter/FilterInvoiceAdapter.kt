...
class FilterInvoiceAdapter(
    private val listener: SelectedInvoiceFiltersListener,
    private val context: Context,
    suppliersList: List<DetailSupplierMgr?>
) : RecyclerView.Adapter<FilterInvoiceAdapter.ViewHolder>() {

    var suppliersList: List<DetailSupplierMgr?>? = null
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        holder.txtFilterName.text = (suppliersList!![position]?.supplier?.supplierName ?: holder.layoutFilterOrderRow.setOnClickListener {
