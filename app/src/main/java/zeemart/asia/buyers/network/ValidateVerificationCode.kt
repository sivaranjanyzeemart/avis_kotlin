...
/**
 * Created by ParulBhandari on 11/13/2017.
 */
...
//
//    public ValidateVerificationCode(String zeemartId, String passCode, Context context, GetRequestStatusResponseListener resetPasswordResponseListener) {
...
//
//        BuyerCredentials.ValidateCode validateCode = new BuyerCredentials.ValidateCode(passCode,zeemartId);
//        return ZeemartBuyerApp.gsonExposeExclusive.toJson(validateCode);
//
...
////        resetPasswordRequestMap.put(ServiceConstant.REQUEST_BODY_VERIFICATION_CODE,passCode);
////        try
////        {
...
//    }
//
//    public void callValidateVerificationCodeAPI() {
//        String jsonRequestBody = generateRequestBodyJSON();
//
//        final ZeemartAPIRequest resetPasswordRequest = new ZeemartAPIRequest(context, Request.Method.POST, ServiceConstant.ENDPOINT_VALIDATEVC, jsonRequestBody, null, new Response.Listener<String>() {
//            @Override
